...
@Entity
@Table(name = "Education_polytechnic_admissions_year")
public class Education_polytechnic_admissions_year {
	...
	public Education_polytechnic_admissions_year() {
		super();
		// TODO Auto-generated constructor stub
	}

	public Education_polytechnic_admissions_year(Long id, int loc_category, int loc_id, String year, int polytechnic,
			int industrial_Training_Institutes, int district_Institute_of_Educational_and_Training,
			int engineering_colleges, int iIT_Roorkee) {
		super();
		this.id = id;
		this.loc_category = loc_category;
		this.loc_id = loc_id;
	...
	public String toString() {
		return "Education_polytechnic_admissions_year [id=" + id + ", loc_category=" + loc_category + ", loc_id="
				+ loc_id + ", Year=" + Year + ", Polytechnic=" + Polytechnic + ", Industrial_Training_Institutes="
				+ Industrial_Training_Institutes + ", District_Institute_of_Educational_and_Training="
				+ District_Institute_of_Educational_and_Training + ", Engineering_colleges=" + Engineering_colleges
				+ ", IIT_Roorkee=" + IIT_Roorkee + "]";
	}
