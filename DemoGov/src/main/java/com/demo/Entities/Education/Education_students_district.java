...
@Entity
@Table(name = "Education_students_district")
public class Education_students_district {
	...
	public String toString() {
		return "Education_students_district [id=" + id + ", loc_category=" + loc_category + ", loc_id=" + loc_id
				+ ", Year=" + Year + ", district=" + district + ", Junior_Basic_Schools=" + Junior_Basic_Schools
				+ ", Senior_Basic_Schools=" + Senior_Basic_Schools + ", Senior_Secondary=" + Senior_Secondary
				+ ", Degree_Universities=" + Degree_Universities + "]";
	}

	public Education_students_district(Long id, int loc_category, int loc_id, String year, String district,
			int junior_Basic_Schools, int senior_Basic_Schools, int senior_Secondary, int degree_Universities) {
		super();
		this.id = id;
		this.loc_category = loc_category;
		this.loc_id = loc_id;
	...
	public Education_students_district() {
		super();
