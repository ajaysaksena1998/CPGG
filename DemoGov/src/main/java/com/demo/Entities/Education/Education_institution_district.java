...
public class Education_institution_district {
	...
	public String toString() {
		return "Education_institution_district [id=" + id + ", loc_category=" + loc_category + ", loc_id=" + loc_id
				+ ", Year=" + Year + ", district=" + district + ", Junior_Basic_Schools=" + Junior_Basic_Schools
				+ ", Senior_Secondary=" + Senior_Secondary + ", Degree=" + Degree + ", Universities=" + Universities
				+ ", Deemed_Universities=" + Deemed_Universities + ", IIT=" + IIT + "]";
	}

	public Education_institution_district(Long id, int loc_category, int loc_id, String year, String district,
			int junior_Basic_Schools, int senior_Secondary, int degree, int universities, int deemed_Universities,
			int iIT) {
		super();
		this.id = id;
		this.loc_category = loc_category;
