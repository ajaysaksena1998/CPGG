...
@Entity
@Table(name = "Education_polytechnic_district")
public class Education_polytechnic_district {
	...
	public String toString() {
		return "Education_polytechnic_district [id=" + id + ", loc_category=" + loc_category + ", loc_id=" + loc_id
				+ ", Year=" + Year + ", district=" + district + ", Polytechnic=" + Polytechnic
				+ ", Industrial_Training_Institutes=" + Industrial_Training_Institutes
				+ ", Teachers_Training_Institutes=" + Teachers_Training_Institutes + ", Engineering_colleges="
				+ Engineering_colleges + ", IIT_Roorkee=" + IIT_Roorkee + "]";
	}

	public Education_polytechnic_district(Long id, int loc_category, int loc_id, String year, String district,
			int polytechnic, int industrial_Training_Institutes, int teachers_Training_Institutes,
	...
	public Education_polytechnic_district() {
		super();
