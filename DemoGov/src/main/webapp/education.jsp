...
<body>
	...
	<div class="midsection">
				...
				<div class="options-container">
					<div class="option">
						<input type="radio" class="radio" id="id01" name="category" /> <label
							class="lbl" for="id01">Institution District</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id02" name="category" /> <label
							class="lbl" for="id02">Institution Year</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id03" name="category" /> <label
							class="lbl" for="id03">Polytechnic District</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id04" name="category" /> <label
							class="lbl" for="id04">Polytechnic Year</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id05" name="category" /> <label
							class="lbl" for="id05">Polytechnic Admissions District</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id06" name="category" /> <label
							class="lbl" for="id06">Polytechnic Admissions Year</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id07" name="category" /> <label
							class="lbl" for="id07">Pupil Teacher Ratio District</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id08" name="category" /> <label
							class="lbl" for="id08">Pupil Teacher Ratio Year</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id09" name="category" /> <label
							class="lbl" for="id09">Students District</label>
					</div>

					<div class="option">
						<input type="radio" class="radio" id="id10" name="category" /> <label
							class="lbl" for="id10">Students Year</label>
					</div>
				</div>
		...
		<!--Table Form-->
		<form action="/institution_district" id="institution_district"
			...
			<label for="Year" class="input-labels"><b>Year:</b></label> <input
				type="text" name="Year" class="input-fields" required="required">
			...
			</select> <label for="Junior_Basic_Schools" class="input-labels"><b>Junior
					Basic Schools:</b></label> <input type="text" name="Junior_Basic_Schools"
				class="input-fields" required="required"> <label
				for="Senior_Secondary" class="input-labels"><b>Senior
					Secondary:</b></label> <input type="text" name="Senior_Secondary"
				class="input-fields" required="required"> <label
				for="Degree" class="input-labels"><b>Degree:</b></label> <input
				type="text" name="Degree" class="input-fields" required="required">

			<label for="Universities" class="input-labels"><b>Universities:</b></label>
			<input type="text" name="Universities" class="input-fields"
				required="required"> <label for="Deemed_Universities"
				class="input-labels"><b>Deemed Universities:</b></label> <input
				type="text" name="Deemed_Universities" class="input-fields"
				required="required"> <label for="IIT" class="input-labels"><b>IIT:</b></label>
		...
		<form class="input-form" action="/uploadFile" method="post" id="sample" enctype="multipart/form-data">
		...
		<form action="/institution_year" method="post" id="institution_year"
			...
			<label for="Year" class="input-labels"><b>Year:</b></label> <input
				type="text" name="Year" class="input-fields"> <label
				for="Junior_Basic_Schools" class="input-labels"><b>Junior
					Basic Schools:</b></label> <input type="text" name="Junior_Basic_Schools"
				class="input-fields"> <label for="Senior_Secondary"
				class="input-labels"><b>Senior Secondary:</b></label> <input
				type="text" name="Senior_Secondary" class="input-fields"> <label
				for="Degree" class="input-labels"><b>Degree:</b></label> <input
				type="text" name="Degree" class="input-fields"> <label
				for="Universities" class="input-labels"><b>Universities:</b></label>
			<input type="text" name="Universities" class="input-fields">

			<label for="Deemed_Universities" class="input-labels"><b>Deemed
					Universities:</b></label> <input type="text" name="Deemed_Universities"
				class="input-fields"> <label for="IIT" class="input-labels"><b>IIT:</b></label>
			<input type="text" name="IIT" class="input-fields">
		...
		<form action="/polytechnic_district" id="polytechnic_district"
			method="post" class="input-form">
			<h1 class="heading">Polytechnic District:</h1>

			<label for="Year" class="input-labels"><b>Year:</b></label> <input
				type="text" name="Year" class="input-fields"> <label
				for="district" class="input-labels"><b>District:</b></label> <select
				name="district" id="Dis-select">
				<option value="">Please choose an District</option>
				<option value="Uttarakhand">Uttarakhand</option>
				<option value="Chamoli">Chamoli</option>
				<option value="Tehri">Tehri</option>
				...
				<option value="Garhwal Mandal">Garhwal Mandal</option>
				<option value="Kumoun Mandal">Kumoun Mandal</option>
			</select> <label for="Polytechnic" class="input-labels"><b>Polytechnic:</b></label>
			<input type="text" name="Polytechnic" class="input-fields"> <label
				for="Industrial_Training_Institutes" class="input-labels"><b>Industrial
					Training Institutes:</b></label> <input type="text"
				name="Industrial_Training_Institutes" class="input-fields">

			<label for="Teachers_Training_Institutes" class="input-labels"><b>Teachers
					Training Institutes:</b></label> <input type="text"
				name="Teachers_Training_Institutes" class="input-fields"> <label
				for="Engineering_colleges" class="input-labels"><b>Engineering
					Colleges:</b></label> <input type="text" name="Engineering_colleges"
				class="input-fields"> <label for="IIT_Roorkee"
				class="input-labels"><b>IIT Roorkee:</b></label> <input type="text"
				name="IIT_Roorkee" class="input-fields">
		...
		<form action="/polytechnic_year" id="polytechnic_year" method="post"
			class="input-form">
			<h1 class="heading">Polytechnic Year:</h1>

			<label for="Year" class="input-labels"><b>Year:</b></label> <input
				type="text" name="Year" class="input-fields"> <label
				for="Polytechnic" class="input-labels"><b>Polytechnic:</b></label> <input
				type="text" name="Polytechnic" class="input-fields"> <label
				for="Industrial_Training_Institutes" class="input-labels"><b>Industrial
					Training Institutes:</b></label> <input type="text"
				name="Industrial_Training_Institutes" class="input-fields">
		...
		<form action="/polytechniciti_admissions_district"
			id="polytechniciti_admissions_district" method="post"
			class="input-form">
			...
			<label for="District_Institute_of_Educational_and_Training"
				class="input-labels"><b>District Institute of
					Educational and Training:</b></label> <input type="text"
				name="District_Institute_of_Educational_and_Training"
				class="input-fields"> <label for="Engineering_colleges"
				class="input-labels"><b>Engineering Colleges:</b></label> <input
				type="text" name="Engineering_colleges" class="input-fields">

			<label for="IIT_Roorkee" class="input-labels"><b>IIT
					Roorkee:</b></label> <input type="text" name="IIT_Roorkee" class="input-fields">
		...
		<form action="/polytechniciti_admissions_year"
			id="polytechniciti_admissions_year" method="post" class="input-form">
		...
		<form action="/pupil_teacher_ratio_district"
			id="pupil_teacher_ratio_district" method="post" class="input-form">
			...
			<label for="Year" class="input-labels"><b>Year:</b></label> <input
				...
				<option value="Kumoun Mandal">Kumoun Mandal</option>
					...
					Basic Schools:</b></label> <input type="text" name="Junior_Basic_Schools"
				class="input-fields"> <label for="Senior_Basic_Schools"
				class="input-labels"><b>Senior Basic Schools:</b></label> <input
				type="text" name="Senior_Basic_Schools" class="input-fields">
		...
		<form action="/pupil_teacher_ratio_year" id="pupil_teacher_ratio_year"
			method="post" class="input-form">
		...
		<form action="/students_district" id="students_district" method="post"
			class="input-form">
			...
			<label for="Senior_Secondary" class="input-labels"><b>Senior
					Secondary:</b></label> <input type="text" name="Senior_Secondary"
				class="input-fields"> <label for="Degree_Universities"
				class="input-labels"><b>Degree Universities:</b></label> <input
				type="text" name="Degree_Universities" class="input-fields">
		...
		<form action="/students_year" id="students_year" method="post"
			class="input-form">
