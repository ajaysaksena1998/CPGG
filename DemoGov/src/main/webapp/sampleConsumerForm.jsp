...
<body>
<div class="container">
<form action="/postconsumer" id="institution_district" method="POST" class="input-form">
           ...
           <div class="row">
            ...
            <label for="Junior_Basic_Schools" class="input-labels"><b>Index</b></label>
            <input type="text" id="Junior_Basic_Schools" name="ind" class="input-fields" value="${value.ind}">
