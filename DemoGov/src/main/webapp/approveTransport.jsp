...
<body>
    ...
    <div class="midsection">
        <h1 class="department-midsection-text">Departments: Transportation & Communication</h1>
...
<!-- 			<th width="10%" scope="col">Location Category</th>
			...
			<th width="10%" scope="col">Heavy Vehicles</th>
			<th width="10%" scope="col">Delivery/Recovery Van</th>
			<th width="10%" scope="col">Buses</th>
			<th width="10%" scope="col">Taxi Cab</th>
			<th width="10%" scope="col">Three Wheelers</th>
			<th width="10%" scope="col">Two Wheelers</th>
			<th width="10%" scope="col">Four Wheelers</th>
			<th width="10%" scope="col">Others</th>
		...
		<c:forEach items="${list}" var="list">
			<tr>
				...
				<td>${list.heavy_vehicles }</td>
				<td>${list.deliver_recovery_van }</td>
				<td>${list.buses}</td>
				<td>${list.maxi_taxi_cab }</td>
				<td>${list.three_wheelers }</td>
				<td>${list.two_wheelers }</td>
				<td>${list.four_wheelers }</td>
				<td>${list.others }</td>
				<td>${list.total }</td>
				 <td><button class="btn btn-primary"><a href="/previewtransport/${list.id }" style="color: white;">Preview</a></button></td>
				...
				<button class="btn btn-success"><a href="/transportapproved" style="color: white;" onclick="func();">Approve</a></button>
		</div>
        </form>
